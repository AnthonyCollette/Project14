...
const Homepage = () => {
    ...
    return (
        <main>
            ...
            {openModal && <CustomizableReactModal color='#669bbc' title="Congratulations !" titleAlign="center" crossColor="#669bbc" text="Employee Created !" textAlign="center" btnFilled btnText='Close modal' btnBorderRadius={5} btnAlign="center" btnPadding="10px 30px" handleCrossBtn={handleCrossBtn} btnCross border="2" handleModalBtn={handleModalBtn} />}
        </main>
    );
};
